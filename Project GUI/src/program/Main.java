...
//					createdb();
	...
	private static void createdb() {
		...
		DatabaseRetrieval.executeUpdate("CREATE TABLE clothesshop.Manages\r\n" + "(\r\n"
		...
		DatabaseRetrieval
				.executeUpdate("CREATE INDEX ReceiptIdIndex on clothesshop.Receipt (ReceiptID ASC);");
		...
		DatabaseRetrieval.executeUpdate("CREATE TABLE clothesshop.Clothes (\r\n"
				...
				+ "	FOREIGN KEY (ClientID) REFERENCES Clients (ClientID)\r\n" + ");");
		DatabaseRetrieval
				.executeUpdate("CREATE INDEX ClothesIdIndex on clothesshop.clothes (ClothesID ASC);");
		...
		DatabaseRetrieval.executeUpdate("CREATE TABLE clothesshop.Tops (\r\n"
				...
				+ "    `Size` VARCHAR(10),\r\n" + "    `Type` VARCHAR(50)\r\n" + ");");
		DatabaseRetrieval
				.executeUpdate("CREATE INDEX TopsClothesIdIndex on clothesshop.Tops (ClothesID ASC);");
		...
		DatabaseRetrieval.executeUpdate("CREATE TABLE clothesshop.Pants (\r\n"
				...
				+ "    `Inseam` VARCHAR(50)\r\n" + ");");
		DatabaseRetrieval
				.executeUpdate("CREATE INDEX PantsClothesIdIndex on clothesshop.Pants (ClothesID ASC);");
		...
		DatabaseRetrieval.executeUpdate("CREATE TABLE clothesshop.Hats (\r\n"
				...
				+ "    `Size` VARCHAR(50),\r\n" + "    `Type` VARCHAR(50)\r\n" + ");");
		DatabaseRetrieval
				.executeUpdate("CREATE INDEX HatsClothesIdIndex on clothesshop.Hats (ClothesID ASC);");
		...
		DatabaseRetrieval.executeUpdate("CREATE TABLE clothesshop.Shoes (\r\n"
				...
				+ "    `Laces` VARCHAR(50)\r\n" + ");");
		DatabaseRetrieval
				.executeUpdate("CREATE INDEX ShoesClothesIdIndex on clothesshop.Shoes (ClothesID ASC);");
		...
		DatabaseRetrieval
				.executeUpdate("create table clothesshop.Supply (\r\n" + "   SupplierID int NOT NULL,\r\n"
						+ "   ClothesID int NOT NULL,\r\n" + "   PRIMARY KEY (SupplierID, ClothesID), \r\n"
						+ "   FOREIGN KEY (SupplierID) REFERENCES Suppliers (SupplierID),\r\n"
						+ "   FOREIGN KEY (ClothesId) REFERENCES Clothes (ClothesId)\r\n" + ");");
		DatabaseRetrieval
				.executeUpdate("CREATE INDEX SupplyClothesIdIndex on clothesshop.Supply (ClothesID ASC);");
		DatabaseRetrieval.executeUpdate(
...
//		
//		
		DatabaseRetrieval.executeUpdate("INSERT INTO clothesshop.Worker\r\n"
		...
		DatabaseRetrieval.executeUpdate("INSERT INTO clothesshop.Tops\r\n"
		...
		DatabaseRetrieval.executeUpdate("INSERT INTO clothesshop.Shoes\r\n"
		...
		DatabaseRetrieval
				.executeUpdate("INSERT INTO clothesshop.ClothesReceipt\r\n" + "(ClothesID, ReceiptID)\r\n"
						+ "VALUES\r\n" + "('1','1'),\r\n" + "('5','2'),\r\n" + "('6','2'), 	\r\n"
						+ "('3','3'),\r\n" + "('11','3'), \r\n" + "('2','4'),\r\n" + "('9','5');");
		DatabaseRetrieval.executeUpdate(
		...
		DatabaseRetrieval
				.executeUpdate("INSERT INTO clothesshop.Supply\r\n" + "(`ClothesID`, `SupplierID`)\r\n"
						+ "VALUES\r\n" + "('1', '1'),\r\n" + "('2', '1'),\r\n" + "('3', '2'),\r\n"
						+ "('4', '1'),\r\n" + "('5', '2'),\r\n" + "('6', '2'),\r\n" + "('7', '1'),\r\n"
						+ "('8', '2'),\r\n" + "('9', '2'),\r\n" + "('10', '1'),\r\n" + "('11', '1');");
